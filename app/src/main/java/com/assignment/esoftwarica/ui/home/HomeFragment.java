...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("Conor", "PKR", "Male", "18",R.drawable.noimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Sagar KC", "Samakhushi", "Male", "23", R.drawable.maleimg));
            studentsList.add(new Students("Sita KC", "Baglung", "female", "22", R.drawable.femaleimg));
